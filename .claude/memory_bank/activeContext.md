...
**Phase 1 — L0 + L1 + L2 + L3 + L4 + L5 + L6 T-28 COMPLETE (T-01 through T-28, 2026-05-19). Template-based remediation lit up: 18 per-ruleId templates + category-fallback + 20-spec test coverage invariant.**
**Next: T-29 LLM-enriched remediation + `suggest <report.json>` subcommand → L7 CLI wire-up → L8 CI → L9 Phase α gate.**
