...
<!-- generated_at: 2026-05-18T18:57:22.571Z -->
...
|---|---:|---:|---:|
| 01-clean-production.json | 0 | 0 | 1.424 |
| 02-cloud-metadata-ssrf.json | 1 | 1 | 0.444 |
| 03-supply-chain-mixed.json | 3 | 3 | 0.81 |
| 04-auth-gap-cluster.json | 4 | 4 | 0.418 |
| 05-command-injection.json | 3 | 3 | 0.125 |
